...
function taskRow(t){
  ...
  // Menggunakan kutip tunggal di onclick='...' biar gak tabrakan dengan stringify JSON
  return `<div class="tr" onclick='openTaskDetail(${tid})' style="position: relative; cursor: pointer;">
    ...
    <div class="pbar" title="Klik % untuk update" onclick="event.stopPropagation(); updateProgress(${tid})"><div class="pbar-fill" style="width:${t.progress}%"></div></div>
